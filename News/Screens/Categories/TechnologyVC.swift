...
protocol TechnologyVCDelegate: AnyObject {
    func didTapMenuButton()
}

class TechnologyVC: UIViewController {
    
    var delegate: TechnologyVCDelegate?
...
extension TechnologyVC: UITableViewDataSource, UITableViewDelegate {
